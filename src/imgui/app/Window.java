 ...
 */
public abstract class Window extends ImUtil{
    protected ImGuiImplGlfw imGuiGlfw = new ImGuiImplGlfw();
//    protected ImGuiImplGl3 imGuiGl3 = new ImGuiImplGl3(); //Rendering is baked inside the native library
...
//        imGuiGl3.renderDrawData(ImGui.GetDrawData());
    ...
    /**
     * @return The current glsl shader version
     */
